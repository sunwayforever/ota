...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, :version => { :date => @version.date, :release_note => @version.release_note, :version => @version.version }
    end
  ...
  test "should update version" do
    put :update, :id => @version, :version => { :date => @version.date, :release_note => @version.release_note, :version => @version.version }
    assert_redirected_to version_path(assigns(:version))
  end
